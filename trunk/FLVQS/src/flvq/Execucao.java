...
public class Execucao {
	...
	public static void main(String args[]){
		...
		for(int w = 1; w <= 9; w++){
			//Vetor.pasta = "D:\\Comites\\Final\\Assinatura\\ASSETS_CONF - E" + w + "//";
			Vetor.pasta = "D:\\Comites\\Mov" + w + "\\";
			System.out.println("ASSETS_CONF - E" + w);
			System.out.println();
		try{
			//for(double q = 1; q < 2; q = q + 0.1)
			//	for(double o = 0.01; o < 1; o = o + 0.01)
			for(int a = 1; a <= 7; a++){
				//System.out.println(q + " " + o);
				System.out.println(a + " clusters");
				try{				
					
					FLVQ treino = new FLVQ("treino.txt", a, 1.3, 1.01, 30, 0.001);
				...
				Vetor arqTeste = new Vetor("treino.txt", true);
				...
				for(i = 0; i < a; i++){
					...
					try{
						...
						FLVQS treinamento = new FLVQS("fld_" + a +"_treino_"+ numArq +".txt", 1.1, 0.03, 70);
						treinamento.treina();
